...
export const repo = {
  ...
  success: (fullName, response) =>
    action(REPO[SUCCESS], { fullName, response }),
...
export const stargazers = {
  ...
  success: (fullName, response) =>
    action(STARGAZERS[SUCCESS], { fullName, response }),
...
export const loadMoreStargazers = fullName =>
  action(LOAD_MORE_STARGAZERS, { fullName })
